...
const JewelryBoxVersionOneOrderFrom = () => {
  ...
  const [cartItems, setCartItems] = useState([
    { id: 1, name: "ম্যাগনেটিক হার্ট নেকলেস V2 ", price: 10.99, quantity: 1 },
  ]);
                          ...
                          <div className=" lg:mt-0 mt-16">
                            ...
                            <div className=" grid grid-cols-2 mt-4 border-b-2 border-dotted pb-3 border-[#7A7A7A]">
                              <div className=" flex">
                                ...
                                />
                                <h1 className=" lg:text-[20px] text-[18px]">
                                  ম্যাগনেটিক হার্ট নেকলেস V2 - Silver
                                </h1>
                              </div>
...
export default JewelryBoxVersionOneOrderFrom;
