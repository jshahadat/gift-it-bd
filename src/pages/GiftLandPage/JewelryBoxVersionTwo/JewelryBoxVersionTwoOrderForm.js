...
const JewelryBoxVersionTwoOrderForm = () => {
  ...
  const [cartItems, setCartItems] = useState([
    { id: 1, name: "জুয়েলারি বক্স - V2", price: 10.99, quantity: 1 },
  ]);
  ...
  return (
    <div className=" mt-16" name="order-form">
      <div>
        <svg
...
export default JewelryBoxVersionTwoOrderForm;
